...
<section class="py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form action="{{ route('login') }}" class="mx-auto mx-lg-0" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn__primary btn__bordered btn__block">
                            <i class="fa fa-paper-plane mr-1"></i> Masuk Sekarang
                        </button>
                    </div>
                    ...
                    <div class="form-group">
                        Belum Punya Akun?
                        <a class="font__size-14 line__height-24 brk-base-font-color text-decoration_underline" href="{{ route('register')}}">Daftar Sekarang</a>
                    </div>
                </form>
            </div>
        </div>
